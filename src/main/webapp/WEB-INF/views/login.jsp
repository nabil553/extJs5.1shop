  ...
  <head>
	...
	<body class="login-layout">		
	 <div class="login-container">
			...
			<div class="center">
				<h1><i class="icon-coffee  blue"></i>&nbsp;<span class="red">XX</span><span class="white">后台管理系统</span></h1>
			...
			<div id="signup-box" class="signup-box widget-box no-border">
				<div class="widget-body">
					<div class="widget-main">
						...
						<p> 请输入您的注册邮箱: </p>
						<form action="addSys_User" method="post">
							<fieldset>
								<label class="block clearfix">
									<span class="block input-icon input-icon-right">
								...
								<label class="block clearfix">
									<span class="block input-icon input-icon-right">
										<input type="text" name="adminName" class="form-control" placeholder="用户名" /><i class="icon-user"></i>
									</span>
								</label>
								<label class="block clearfix">
									<span class="block input-icon input-icon-right">
										<input type="password" name="adminPwd" class="form-control" placeholder="密码" /><i class="icon-lock"></i>
									</span>
								</label>
								<div class="clearfix">
